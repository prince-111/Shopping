  ...
  return (
    <div
      className="flex flex-col items-center justify-center border-2 shadow-sm  gap-y-4 px-4 rounded-xl bg-white text-slate-700
                    hover:shadow-2xl hover:shadow-slate-500 hover:drop-shadow-2xl hover:scale-95 transition-all duration-500 "
    >
      <div className="px-9 flex flex-col items-center justify-center gap-y-4 my-2 relative">
        ...
        {/* <span className="flex items-center absolute bottom-0 left-0 text-yellow-500">
          {rating.count}
          <AiFillStar />
        </span> */}
      </div>
