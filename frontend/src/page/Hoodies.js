...
const Hoodies = () => {
  return (
    <div>
        <div>
            <img src="https://www.beyoung.in/api/catalog/products/banner_desktop/Winter-Wear-desktop-view_06_01_2024.jpg" alt="" />
        </div>

        <div className="container mx-6">
        <h3>Hoodies FOR MEN</h3>
        <p className="flex-auto mt-2 mb-1">
          Shop Hoodies for men online from Beyoung’s diverse collections. You
