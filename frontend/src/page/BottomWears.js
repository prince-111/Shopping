...
const BottomWears = () => {
  return (
    <div>
        <div>
            <img src="https://www.beyoung.in/api//cache/catalog/products/banner_desktop/jeans-banner-desktop-view_25_12_2023_1920x475.jpg" alt="" />
        </div>

        <div className="container mx-6">
        <h3>Boottm Wear FOR MEN</h3>
        <p className="flex-auto mt-2 mb-1">
          Shop Bottom Wear for men online from Beyoung’s diverse collections. You
