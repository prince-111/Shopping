...
const Shirts = () => {
  return (
    <div>
        <div>
            <img src="https://www.beyoung.in/api/catalog/products/banner_desktop/BB-shirt-category-banner-desktop-view_19_10_2023.jpg" alt="" />
        </div>

        <div className="container mx-6">
        <h3>SHIRTS FOR MEN</h3>
        <p className="flex-auto mt-2 mb-1">
          Shop Shirts for men online from Beyoung’s diverse collections. You
